              ...
              <Table striped bordered hover className="vertical">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>시각디자인과, <a href="#tag11"><FontAwesomeIcon icon={faCamera} />사진영상실</a>, 미디어제작실, <a href="#tag12"><FontAwesomeIcon icon={faBook} />도서관</a>, <FontAwesomeIcon icon={faDumbbell} />체력단련실, 강당, <FontAwesomeIcon icon={faChalkboardTeacher} />제3교무실</td>
                    </tr>
                    <tr>
       ...
       <a name="tag1"></a>
        ...
        <Carousel.Item interval ={3000}>
            <img
                ...
                src="https://i0.wp.com/www.strengthlog.com/wp-content/uploads/2021/11/Bench-press-muscles-worked.jpg?w=1125&ssl=1"
                alt="First Slide"
                />
            <Carousel.Caption>
                <h3>학교 전경</h3>
